...
public class PlayerSimulator : MessageBehaviour
{
    ...
    {
        Messenger.SendToListeners(new Insects_swarm(gameObject, "Insects_of_swarm", "",
            new Vector4(swarm1_count, swarm2_count, swarm3_count, swarm4_count)));
        swarm1_count = 0;
        swarm2_count = 0;
        swarm3_count = 0;
        swarm4_count = 0;
        ...
        */
            ...
            GameObject.FindGameObjectWithTag("creature2_") != null)
        {
            huntEnabled = false;
                                                ...
                                                creature1.GetComponent<CreatureController>().myCharState ==
                                                CreatureController.CharState.Initial ||
                                                creature1.GetComponent<CreatureController>().myCharState ==
                                                CreatureController.CharState.Idle ||
                                                creature1.GetComponent<CreatureController>().myCharState ==
                                                CreatureController.CharState.Long_idle ||
                                                creature1.GetComponent<CreatureController>().myCharState ==
                                                CreatureController.CharState.Walking ||
                                                creature1.GetComponent<CreatureController>().myCharState ==
                                                CreatureController.CharState.Running ||
                                                creature1.GetComponent<CreatureController>().myCharState ==
                                                CreatureController.CharState.Going_to_other_player ||
                                                creature1.GetComponent<CreatureController>().myCharState ==
                                                CreatureController.CharState.Pointing))
        {
            huntEnabled = true;
        }
        else if (gameObject.tag == "Player2" && (creature2 == null ||
                                                 creature2.GetComponent<CreatureController>().myCharState ==
                                                 CreatureController.CharState.Initial ||
                                                 creature2.GetComponent<CreatureController>().myCharState ==
                                                 CreatureController.CharState.Idle ||
                                                 creature2.GetComponent<CreatureController>().myCharState ==
    ...
    {
        if(isLevelSelection)return;
        if (gameObject.name == "Player1")
        {
            GameObject userSwarm1 = GameObject.FindGameObjectWithTag("SwarmPlayer1");
        ...
        if ((swarm1.position - myTransform.position).sqrMagnitude < distanceToCatch * distanceToCatch &&
            emptyswarm1 == false)
        {
            if (timerswarm1 == 0)
            {
                ...
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Close_to_swarm_player1", "free_swarm1",
                        swarm1));
                }

                if (gameObject.tag == "Player2")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Close_to_swarm_player2", "free_swarm1",
                        swarm1));
                }
            }
            ...
            if (timerswarm1 > timeToCatch)
            {
                if (gameObject.tag == "Player")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Insect_catched_player1", "free_swarm1",
                        swarm1));
                }

                if (gameObject.tag == "Player2")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Insect_catched_player2", "free_swarm1",
                        swarm1));
                }
        ...
        else
        {
            if (timerswarm1 != 0)
            {
                ...
                if (gameObject.tag == "Player")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Away_from_swarm_player1",
                        "free_swarm1", swarm1));
                }

                if (gameObject.tag == "Player2")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Away_from_swarm_player2",
                        "free_swarm1", swarm1));
                }
            }
        ...
        if ((swarm2.position - myTransform.position).sqrMagnitude < distanceToCatch * distanceToCatch &&
            emptyswarm2 == false)
        {
            if (timerswarm2 == 0)
            {
                ...
                if (gameObject.tag == "Player")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Close_to_swarm_player1", "free_swarm2",
                        swarm2));
                }

                if (gameObject.tag == "Player2")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Close_to_swarm_player2", "free_swarm2",
                        swarm2));
                }
            }
            ...
            if (timerswarm2 > timeToCatch)
            {
                if (gameObject.tag == "Player")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Insect_catched_player1", "free_swarm2",
                        swarm2));
                }

                if (gameObject.tag == "Player2")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Insect_catched_player2", "free_swarm2",
                        swarm2));
                }
        ...
        if ((swarm3.position - myTransform.position).sqrMagnitude < distanceToCatch * distanceToCatch &&
            emptyswarm3 == false)
        {
            if (timerswarm3 == 0)
            {
                ...
                if (gameObject.tag == "Player")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Close_to_swarm_player1", "free_swarm3",
                        swarm3));
                }

                if (gameObject.tag == "Player2")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Close_to_swarm_player2", "free_swarm3",
                        swarm3));
                }
            }
            ...
            if (timerswarm3 > timeToCatch)
            {
                ...
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Insect_catched_player1", "free_swarm3",
                        swarm3));
                }

                if (gameObject.tag == "Player2") // && creature_user2 == false)
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Insect_catched_player2", "free_swarm3",
                        swarm3));
                }
        ...
        if ((swarm4.position - myTransform.position).sqrMagnitude < distanceToCatch * distanceToCatch &&
            emptyswarm4 == false)
        {
            if (timerswarm4 == 0)
            {
                ...
                if (gameObject.tag == "Player")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Close_to_swarm_player1", "free_swarm4",
                        swarm4));
                }

                if (gameObject.tag == "Player2")
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Close_to_swarm_player2", "free_swarm4",
                        swarm4));
                }
            }
            ...
            if (timerswarm4 > timeToCatch)
            {
                if (gameObject.tag == "Player") // && creature_user1 == false)
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Insect_catched_player1", "free_swarm4",
                        swarm4));
                }

                if (gameObject.tag == "Player2") // && creature_user2 == false)
                {
                    Messenger.SendToListeners(new Message_transform(gameObject, "Insect_catched_player2", "free_swarm4",
                        swarm4));
                }
